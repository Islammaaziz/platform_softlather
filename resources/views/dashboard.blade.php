    ...
    <div class="col-md-4 d-flex">
        <div class="card shadow-sm flex-fill">
            <div class="card-body d-flex flex-column">
                ...
                <a href="{{route('calcul')}}" class="btn btn-primary mt-auto w-100">Aller aux Calculs</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 d-flex">
        <div class="card shadow-sm flex-fill">
            <div class="card-body d-flex flex-column">
                ...
                <a href="{{route('Rapport')}}" class="btn btn-success mt-auto w-100">Voir Rapports</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 d-flex">
        <div class="card shadow-sm flex-fill">
            <div class="card-body d-flex flex-column">
                ...
                <a href="{{route('historique')}}" class="btn btn-warning mt-auto w-100">Voir Historique</a>
            </div>
        </div>
    </div>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                <p><strong>Adresse :</strong> {{ Auth::user()->ville }}</p>
                <p><strong>Adresse :</strong> {{ Auth::user()->code_postal }}</p>
