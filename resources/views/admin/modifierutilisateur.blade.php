  ...
  <div class="section-card">
    <form id="userForm">
      ...
      <div class="d-flex justify-content-end mt-4">
        <button type="button" class="btn-save me-2" onclick="modifierUtilisateur()">
          <i class="fa fa-edit me-1"></i> Modifier
        </button>
        <button type="button" class="btn-delete" onclick="supprimerUtilisateur()">
