                            ...
                            <tr>
                                ...
                                <td>
                                    @if($notification->type === 'success')
                                        <span class="badge bg-success"><i class="fa fa-check-circle me-1"></i>Succès</span>
                                    @elseif($notification->type === 'error')
                                        <span class="badge bg-danger"><i class="fa fa-times-circle me-1"></i>Erreur</span>
                                    @elseif($notification->type === 'info')
                                        <span class="badge bg-info text-dark"><i class="fa fa-info-circle me-1"></i>Info</span>
                                    @else
                                        <span class="badge bg-secondary"><i class="fa fa-bell me-1"></i>Autre</span>
                                    @endif
                                </td>
                                <td class="text-start">{{ $notification->data['message'] }}</td>
                                <td> {{ $notification->created_at->format('d/m/Y') }} 
    <strong>{{ $notification->created_at->format('H:i') }}</strong></td>
                                <td>
