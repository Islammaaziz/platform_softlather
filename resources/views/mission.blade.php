...
<body>
    ...
    <section class="hero">
        <div class="mission-container">
          <h2><i class="fas fa-laptop-code"></i> Mission Informatique & Web services</h2>
      
          <ul class="mission-list">
            <li><i class="fas fa-code"></i> Conception et développement d’applications web et mobiles sur mesure.</li>
            <li><i class="fas fa-globe"></i> Création et maintenance de sites internet professionnels et e-commerce.</li>
            <li><i class="fas fa-cloud"></i> Intégration de solutions cloud (hébergement, sauvegarde, services SaaS).</li>
            <li><i class="fas fa-server"></i> Déploiement et administration de serveurs (Linux, Windows, virtualisation).</li>
            <li><i class="fas fa-shield-alt"></i> Cybersécurité : audit, protection des données et conformité RGPD.</li>
            <li><i class="fas fa-sync-alt"></i> Automatisation des processus métiers et interconnexion des systèmes.</li>
            <li><i class="fas fa-network-wired"></i> Installation et configuration de réseaux informatiques.</li>
            <li><i class="fas fa-headset"></i> Support technique et assistance personnalisée aux utilisateurs.</li>
            <li><i class="fas fa-chart-line"></i> Développement de tableaux de bord et outils d’analyse de données.</li>
          </ul>
        </div>
      </section>
